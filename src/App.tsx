          ...
          <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 min-h-screen ${
            ...
            <nav className="mt-6 px-3">
              <div className="space-y-1">
                ...
                <a href="/strip-poker" className="flex items-center px-3 py-2 text-sm font-medium text-gray-700 rounded-md hover:bg-purple-100 hover:text-purple-900">
                  <svg className="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                  </svg>
                  Strip Poker
                </a>
                <a href="/position-game" className="flex items-center px-3 py-2 text-sm font-medium text-gray-700 rounded-md hover:bg-purple-100 hover:text-purple-900">
                  <svg className="mr-3 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
